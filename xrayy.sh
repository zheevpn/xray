...
REPO="https://raw.githubusercontent.com/${anuku}/${waduh}/main/"
...
apt install unzip -y
wget "${REPO}files/menu.zip" >/dev/null 2>&1
    rm -rf /tmp/menu
    mkdir /tmp/menu
...
echo ""
echo -e "${BB}—————————————————————————————————————————————————————————${NC}"
echo -e "                ${WB}MINI SCRIPT BY ZheeVpnTunneling${NC}"
echo -e "${BB}—————————————————————————————————————————————————————————${NC}"
...
read "${YB}[ Y/N ] For Menu ${NC} : " answer
